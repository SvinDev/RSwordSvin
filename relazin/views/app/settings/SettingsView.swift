            ...
            List {
                ...
                Section {
                    if !mgr.hasOffsets {
                        ...
                        Button("Remove Kernelcache", action: {
                            Alertinator.shared.alert(title: "Clear Kernelcache Data?", body: "This will delete all kernelcache data and remove saved offsets. You will have to refetch the data to use RSwordSvin again.", actionLabel: "Confirm", action: {
                                clearKcacheData()
                            })
                        })
                        .foregroundColor(.red)
                ...
                Section(header: HeaderLabel(text: "RemoteCall", icon: "syringe")) {
                    ...
                    if isIOS16() {
                        ...
                        Text("Warning: If RSwordSvin exits while RemoteCall is active, SpringBoard may respring.")
                            .font(.footnote.weight(.semibold))
                            .foregroundColor(.red)
